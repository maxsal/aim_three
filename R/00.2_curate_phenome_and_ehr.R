...
first_cancer <- first_restricted[phecode %in% cancer_phecodesx_spec, ]
...
qsave(
  as_tibble(charlson),
  file = glue("data/private/mgi/{opt$mgi_version}/charlsonx_{opt$mgi_version}.qs")
)
qsave(
  as_tibble(elixhauser),
  file = glue("data/private/mgi/{opt$mgi_version}/elixhauserx_{opt$mgi_version}.qs")
)
...
qsave(
  demo,
  file = glue("data/private/mgi/{opt$mgi_version}/demo_com_labs_ehr_{opt$mgi_version}.qs")
)
